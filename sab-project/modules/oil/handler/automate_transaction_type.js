...
async function handleGetAll(ctx, req, res) {
    ...
    let items = await ctx.getAutomatedTransactionTypeRepository().selectList(options, pagination)
...
async function handleGetById(ctx, req, res) {
    ...
    let result = await ctx.getAutomatedTransactionTypeRepository().selectById(id)
